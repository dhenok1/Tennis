...
class MiniCourt():
    def __init__(self,frame):
        ...
        # Buffer between mini court display and screen edges
        self.buffer = 50
        self.padding_court=20

        # Set positions for all elements of the minicourt
    ...
    # Draw the keypoints on the mini court
    ...
    # Set the mini court postion within the canvas  
    def set_mini_court_position(self):
        # Calculate position of mini court relative to background
    ...
    # Sets position of canvas background in the current frame
    def set_canvas_background_box_position(self,frame):
        frame= frame.copy()

        # Calculate position of display on screen
    ...
    # Draw the background rectangle for the mini court
    def draw_background_rectangle(self,frame):
        ...
        # 50% transparent
        alpha=0.5
        # Mask to pervent other part of frame getting affected
        mask = shapes.astype(bool)
        # Adds to keep opacity effect
    ...
    # Get coordinatees of players relative to the mini court
    ...
    # Draws players onto the mini court
